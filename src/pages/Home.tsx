    ...
    <div>
        ...
        <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/projects" 
                className="bg-portfolio-brown hover:bg-portfolio-dark-brown text-white px-6 py-3 rounded-md transition-all flex items-center gap-2"
              >
                View Projects <ArrowRight size={18} />
              </Link>
              <Link 
                to="/contact" 
                className="bg-transparent border-2 border-portfolio-brown text-portfolio-brown hover:bg-portfolio-brown hover:text-white px-6 py-2.5 rounded-md transition-all"
              >
                Contact Me
              </Link>
            </div>
          ...
          <div className="relative mx-auto">
            ...
            <div className="absolute -bottom-6 -right-6 bg-portfolio-cream rounded-lg shadow-lg p-4 animate-fade-up" style={{ animationDelay: '0.3s' }}>
              <p className="font-medium text-portfolio-dark-brown">MBA Business Analytics</p>
              <p className="text-sm text-portfolio-gray">CGPA 9.1</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white section">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link 
              to="/about" 
              className="text-portfolio-brown hover:text-portfolio-dark-brown inline-flex items-center gap-2 font-medium"
            >
      ...
      <section className="bg-portfolio-beige section">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all">
              ...
              <div className="p-6">
                ...
                <Link 
                  to="/projects" 
                  className="text-portfolio-brown hover:text-portfolio-dark-brown inline-flex items-center gap-2"
                >
          ...
          <div className="text-center mt-12">
            <Link 
              to="/projects" 
              className="bg-portfolio-brown hover:bg-portfolio-dark-brown text-white px-6 py-3 rounded-md transition-all inline-flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                {['Excel', 'Python', 'SQL', 'Power BI', 'Tableau', 'MS Word', 'PowerPoint'].map((skill) => (
            ...
            <div>
              ...
              <div className="space-y-4">
                {['Communication', 'Teamwork', 'Leadership', 'Analytical Thinking', 'Problem Solving', 'Time Management', 'Adaptability'].map((skill) => (
                  <div key={skill} className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-portfolio-brown"></div>
                    <span className="text-portfolio-gray">{skill}</span>
                  </div>
      ...
      <section className="bg-portfolio-brown text-white py-16">
        <div className="container-custom text-center">
          ...
          <Link 
            to="/contact" 
            className="bg-white text-portfolio-brown hover:bg-portfolio-cream hover:text-portfolio-dark-brown px-8 py-3 rounded-md transition-all inline-flex items-center gap-2 font-medium"
          >
